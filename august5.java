...
// Components for the regularPanel
    ...
    addRegularbt.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e){
        ...
        Regular reg=new Regular(studentName,dateOfBirth,courseName,enrollmentId,dateOfEnrollment,courseDuration,tuitionFee,numOfModules,numOfDaysPresent,numOfModules,numOfCreditHours,daysPresent);
        studental.add(reg);
        regularal.add(reg);
